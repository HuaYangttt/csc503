...
% Courses taken 
% Orientation course
hasTakenCourse(s002, csc600, s001, 1, 75).

% Theory core 
hasTakenCourse(s002, csc503, s001, 3, 82). 

% Systems core
hasTakenCourse(s002, csc501, s001, 3, 78).  

% Electives
hasTakenCourse(s002, csc565, s001, 3, 75).
hasTakenCourse(s002, csc579, s001, 3, 70).
hasTakenCourse(s002, csc630, s001, 3, 85).
hasTakenCourse(s002, csc580, s001, 3, 72).
hasTakenCourse(s002, csc591, s001, 3, 72).


%canGraduate(SID, msc).
%hasToBeTerminated(SID, msc). 
%whyCanOrCannotTake(SID, CID, Sect). 
%recommendSemesterWork(SID, msc). 